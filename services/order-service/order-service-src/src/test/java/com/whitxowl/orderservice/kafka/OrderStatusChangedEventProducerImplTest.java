...
import com.whitxowl.orderservice.kafka.producer.impl.OrderStatusChangedEventProducerImpl;
...
@Testcontainers
class OrderStatusChangedEventProducerImplTest {
    ...
    private OrderStatusChangedEventProducerImpl producer;
    ...
    void setUp() {
        ...
        producer = new OrderStatusChangedEventProducerImpl(kafkaTemplate);
    ...
    void produce_shouldDeliverEvent_withCorrectContent() {
        ...
        producer.produce(orderId, "user-1", "product-1", 3, "RESERVED");
        kafkaTemplate.flush();

        OrderStatusChanged received = pollFrom(offsetBefore);
        ...
        assertThat(received.getStatus()).isEqualTo("RESERVED");
    ...
    void produce_shouldUseOrderIdAsMessageKey() {
        ...
        producer.produce(orderId, "user-1", "product-1", 1, "CANCELLED");
        kafkaTemplate.flush();
    ...
    private OrderStatusChanged pollFrom(long fromOffset) {
        return (OrderStatusChanged) pollRecordFrom(fromOffset).value();
    }
